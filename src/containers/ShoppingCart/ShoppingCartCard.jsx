          ...
          <div className={styles['info-container']}>
            ...
            <div className={styles['actions-container']}>
              <div className={styles['counter']}>
                <span onClick={() => el.quantity > 1 && dispatch(updateCartItemQuantity({id: el.id, quantity: -1, userId: user.email}))} style={{cursor: 'pointer'}}>-</span>
                <span>{`${el.quantity}`}</span>
                <span onClick={() => validateStock() && dispatch(updateCartItemQuantity({id: el.id, quantity: 1, userId: user.email}))} style={{cursor: 'pointer'}}>+</span>
              </div>
