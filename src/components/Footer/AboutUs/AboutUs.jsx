...
const AboutUs = () => {
  ...
  return (
    <div className={styles.aboutUs}>
      ...
      <div className={styles.contentWrapper}>
        ...
        <div id="right-content" className={styles.rightContent}>
          ...
          <ul>
            ...
            <li><span>Accesories and spare parts:</span> comprehensive range of accessories and spare parts</li>
          </ul>
        </div>
      </div>

      <div id="first-card" style={{ marginBottom: '60px' }} className={styles.card}>
        <div className={styles.bg}></div>
        <h3>MISSION</h3>
      ...
      <div id="second-card" style={{ marginLeft: 'auto', marginBottom: '60px' }} className={styles.card}>
        <div className={styles.bg}></div>
        <h3>VISION</h3>
      ...
      <div id="third-card" style={{ marginBottom: '60px' }} className={styles.card}>
        <div className={styles.bg}></div>
        <h3>VALUES</h3>
      ...
      <div className={styles['find-us']}>
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3736.394371349395!2d-97.46122199999999!3d20.5310389!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85da6be6847d09e3%3A0x7935b743b7dc8d37!2sDINAMO%20MOTOCICLETAS!5e0!3m2!1ses-419!2sar!4v1686630106124!5m2!1ses-419!2sar" width="100%" height="400" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
    </div>
  );
