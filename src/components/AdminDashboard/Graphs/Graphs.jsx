...
const COLORS = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042', "#FF00FF"];
    ...
    <div className={styles['graphs-container']}>
        <div>
            <h1>Amounts entered by Items</h1>
            <h7>This graph shows the items sold and the dollar revenue generated by each item.</h7>
        ...
        <div>
            <h1>Amounts entered by Types</h1>
            <h7>This chart shows the types of items sold and the dollar revenue generated by each.</h7>
            <PieChart width={400} height={400}>
                <Pie
                    data={soldCategories}
                    dataKey="price"
        ...
        <div>
            <h1>Amounts entered by Brands</h1>
            <h7>This graph shows the revenue in dollars of each brand.</h7>
        ...
        <div>
            <h1>Purchases made by Users</h1>
            <h7>This graph shows the number of purchases made by each user.</h7>
